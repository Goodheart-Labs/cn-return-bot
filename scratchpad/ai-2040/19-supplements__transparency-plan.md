...
**Path:** `/supplements/transparency-plan`
...
Proposal #1: Total Research Transparency
...
Proposal #3: Algorithmic Security

	

Proposal #4: Shut it all down




SL5 algorithmic secrets security
...
N/A, no new algos discovered




Allows new training runs
...
How informed are public discussions of safety cases?
...
N/A, no new safety cases needed
...
outputs
(screened to prevent
Opaque info from leaking)
Variable latency
Weights
High Risk
Outputs
Requests for info
Misuse-Infohazardous
Trajectories
Requests for code
...
Visible to
Public Database
Includes all outputs from R&D Datacenters,
outputs from models used for AI R&D, and
all inputs to the R&D datacenters
The Public
AI & Human
AI Researchers
AIs used for AI R&D
...
reports
Public Database
Includes reports from inside the R&D datacenters
Visible to
The Public
Weights
Inference
...
Model Weights. Just like in total research transparency, model weights need to pass from the R&D datacenters to the inference datacenters, and this channel needs to be high bandwidth because model weights are so large.

Auditor Reports. The auditors write up reports about progress inside the R&D datacenters, which include things like current capabilities, safety relevant information about the current architectures. Redacted versions of these reports could be made public.

Humans leaving the security boundary. Human researchers periodically enter and leave the security boundary. This is the main way that we expect algorithms to be exfiltrated from the datacenters.
...
Proposal #4 does not allow for the development of new AI models, i.e. it only works as part of Plan S as opposed to Plan A. The decision about Plan A vs Plan S will mostly be made on other factors, which are discussed more in the Plan S branch.
...
P3 Algorithmic Security

	

~14%

You can see the reasoning behind this estimate here. We would be excited about security experts (which we are not) making their own forecasts; especially forecasts that are more granular (e.g., that include over what time period the algorithms leak).
...
by governments is more
effective; oversight of exec
branch by judiciary,
congress, the public, etc. is
more effective too
Better
understanding of
AI alignment, AI
...
World Has More Time
to Prepare, React,
Adjust to Historically
Fast AI-Driven
Changes
Our key policy interventions
Our main goals
Intermediate outcomes / factors
Arrows represent causation
~ Notice the feedback loop here! ~
...
“Technical conversation no longer dominated by AI company employees.” Transparency will improve epistemics about AI risks, and therefore will make regulations more likely to be implemented well.
...
“Huge increase in the number of alignment researchers with access to the latest models and evidence.” More transparency means more researchers can participate in cutting-edge research, which means progress is made faster.
...
“Incentives not so perverse” Total Research Transparency removes the incentive for AI companies to race to better AI algorithms.
...
It helps to consider an example. In 2026, many AI researchers agree that chain of thought monitorability is helpful for safety and that it would be a shame to lose it. However, each company is individually incentivised to have research programs into new paradigms that would destroy or damage chain of thought monitorability (call this “neuralese”). After all, if they don’t do it, someone else will.
...
“Agreements to pay safety taxes and ban dangerous practices can be verified.” Total Research Transparency makes AI agreements more robust.
...
“No company pulls ahead, others catch up, including companies in other countries.” Having multiple companies spread across multiple countries is great for preventing extreme concentrations of power.
...
You can’t use them for everything—they’ll refuse to help you with some things for example, or possibly even quietly underperform, and

There’s nothing stopping the AI companies from inserting secret loyalties or hidden agendas into their AIs, like xAI and Google appear to have done on occasion (those were the cases that were so blatant as to get caught).
...
“No Secret Loyalties / Hidden Agendas”
...
Unknown Unknowns: Transparency seems good for putting humanity in a position to deal with problems as they come up, including problems that we haven’t thought of yet.
...
- [https://ai-2040.com/supplements/transparency-plan#baseline-transparency-desiderata](https://ai-2040.com/supplements/transparency-plan#baseline-transparency-desiderata)
- [Baseline Transparency Desiderata](https://ai-2040.com/supplements/transparency-plan#baseline-transparency-desiderata)
- [https://ai-2040.com/supplements/transparency-plan#four-transparency-proposals](https://ai-2040.com/supplements/transparency-plan#four-transparency-proposals)
- [Four Transparency Proposals](https://ai-2040.com/supplements/transparency-plan#four-transparency-proposals)
- [https://ai-2040.com/supplements/transparency-plan#total-research-transparency](https://ai-2040.com/supplements/transparency-plan#total-research-transparency)
- [Total Research Transparency](https://ai-2040.com/supplements/transparency-plan#total-research-transparency)
- [https://ai-2040.com/supplements/transparency-plan#filtered-transparency](https://ai-2040.com/supplements/transparency-plan#filtered-transparency)
- [Filtered Transparency](https://ai-2040.com/supplements/transparency-plan#filtered-transparency)
- [https://ai-2040.com/supplements/transparency-plan#when-is-each-proposal-desirable](https://ai-2040.com/supplements/transparency-plan#when-is-each-proposal-desirable)
- [When is each proposal desirable?](https://ai-2040.com/supplements/transparency-plan#when-is-each-proposal-desirable)
- [https://ai-2040.com/supplements/transparency-plan#what-fraction-of-algorithms-will-leak-under-each-proposal](https://ai-2040.com/supplements/transparency-plan#what-fraction-of-algorithms-will-leak-under-each-proposal)
- [What fraction of algorithms will leak under each proposal?](https://ai-2040.com/supplements/transparency-plan#what-fraction-of-algorithms-will-leak-under-each-proposal)
- [https://ai-2040.com/supplements/transparency-plan#total-research-transparency-upsides](https://ai-2040.com/supplements/transparency-plan#total-research-transparency-upsides)
- [Total Research Transparency Upsides](https://ai-2040.com/supplements/transparency-plan#total-research-transparency-upsides)
- [https://ai-2040.com/supplements/transparency-plan#total-research-transparency-downsides](https://ai-2040.com/supplements/transparency-plan#total-research-transparency-downsides)
- [Total Research Transparency Downsides](https://ai-2040.com/supplements/transparency-plan#total-research-transparency-downsides)
- [more](https://ai-2040.com/supplements/transparency-plan#baseline-transparency-desiderata)
- [more](https://ai-2040.com/supplements/transparency-plan#four-transparency-proposals)
- [more](https://ai-2040.com/supplements/transparency-plan#total-research-transparency)
- [more](https://ai-2040.com/supplements/transparency-plan#when-is-each-proposal-desirable)
- [https://ai-2040.com/supplements/transparency-plan#top-toc](https://ai-2040.com/supplements/transparency-plan#top-toc)
- [verification supplement](https://www.ai-2040.com/supplements/verification-plan#zero-data-retention-zdr-inference)
- [Plan S branch](https://www.ai-2040.com/?choices=plan-s-root)
- [here](https://docs.google.com/spreadsheets/d/1zKOxldIPXrz6RypC8Zr50rTpF10yGz4w0UZhNxk78XE/edit?gid=0#gid=0)
- [many AI researchers agree](https://arxiv.org/abs/2507.11473)
- [neuralese](https://ai-2027.com/#narrative-2027-03-31)
- [quietly underperform](https://www.lesswrong.com/posts/sSyLyc3KDQzboQGWS/thoughts-on-claude-fable-s-silent-safeguards)
- [secret loyalties or hidden agendas](https://www.formationresearch.com/secret-loyalties-whitepaper.pdf)
- [xAI](https://www.cnbc.com/2025/07/11/grok-4-appears-to-reference-musks-views-when-answering-questions-.html)
- [Google](https://nypost.com/2024/02/22/business/google-pauses-absurdly-woke-gemini-ai-chatbots-image-tool-after-backlash-over-historically-inaccurate-pictures/)
...
- [the Security supplement](https://docs.google.com/document/d/1nh8g0TnRQZjpSCvlq_M9te_WclgnIt2Mx3iQujfz0Kc/edit?tab=t.0)
