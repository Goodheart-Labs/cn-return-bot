...
**Path:** `/supplements/alignment-roadmap`
...
Prepare. This will centrally involve preparing for control, building misalignment analogies that are as realistic as possible, and various other interventions.

Mitigate + Elicit. During the early intelligence explosion, mitigate the risk of AIs taking catastrophic actions (e.g. staging a rogue internal deployment or backdoor the values of future models). Meanwhile, elicit their capabilities on domains that we care about (e.g. control research, alignment research, security, strategy) and use them to do huge amounts of useful work in these domains. This phase lasts from the early intelligence explosion (specifically ITAI), until Min-H (definitions here).

Pause at Min-H. Once we’ve built AI systems with general purpose capabilities sufficient that we can unsafely hand off trust (Min-H), we pause further AI capabilities progress, and try to build AIs that we can safely hand off trust to. This will centrally involve:

Avoiding alignment faking: AIs aren't so seriously misaligned that they intentionally fake alignment (e.g., they aren't scheming against us).

Solving handoff-viability: AIs are sufficiently capable and aligned at autonomously completing all the relevant work for managing the intelligence explosion, including high-stakes, difficult, open-ended, and conceptually loaded tasks where we can't check the AI's output effectively (e.g. acausal trade research, philosophy).

Handoff. Once we’ve mitigated alignment faking and achieved handoff-viability, then the AI project actually empowers AI systems with the ongoing management of the intelligence explosion.

The main alternative to hand off is to instead stall for more time. The main way of doing that would be to escalate to Plans A or B, which would (typically) require substantial government involvement, which may or may not be feasible. A key priority during the other phases will often be to attempt to escalate the level of political will.

After handoff, our ~human level AI systems that we’ve handed off to will need to solve successively more difficult alignment problems so that they can build vastly superhuman AI systems, or they will need to themselves stall for more time.
...
Quickly retrofitting physical security

Largely relying on software based security methods. See this post for more details.
...
Avoid other failure modes that would make tests unrepresentative. This is just a bunch of miscellaneous possible failure modes that will potentially apply around handoff. For example:

Weird memetic pressures happen at large scale, so that small scale testing is not representative.

People trying to jailbreak your AIs (E.g. China inserting secret loyalties)
...
Standard Plan C. You scale to Min-H AI, work on solving handoff viability and scheming for Min-H AIs. keep control until near the end, then you ditch control, and solve handoff viability. Those AIs then FOOM to the sky.
...
EMs at MaxC. Same as prior, but human augmentation instead of military advantage.

EMs/Military at Min-H. One of the prior 2, but magically do it with AIs that are just around minH level AI, because e.g. military or EMs were easier than we think.
...
Prep. This phase is basically the same as Plan C, because you probably don’t know if there will be international coordination during takeoff. Given positive evidence about political will, our alignment portfolio of research should bias more towards moonshots / approaches that could give high assurance safety cases, as opposed to agendas that are likely to contribute to hand off in a Plan C world.

Mitigate + Elicit. In the Plan A scenario, this corresponds to roughly 2030-2035. For the first few years, there is high risk that international coordination will break down and parties will go back to racing. Therefore, substantial effort should be spent on a high-effort version of Plan C—we should push forward the plan and approach for handoff in the case that the deal breaks down. The main difference with Plan C is that we should be much more conservative with our mitigations; if there’s danger ahead, we are much more able to pause and mitigate.

Pause. Once we get to MaxC AI (or AI that’s close enough to MaxC that there isn’t much point to scaling further), then we pause until handoff. Over time, we can reassign alignment effort from Plan C approaches towards moonshots/high assurance approaches.

Handoff. The basic plan is still to do handoff. However, other exit strategies like an intense deal to prevent ever having to hand off or human augmentation.
...
- [https://ai-2040.com/supplements/alignment-roadmap#summary](https://ai-2040.com/supplements/alignment-roadmap#summary)
- [Summary](https://ai-2040.com/supplements/alignment-roadmap#summary)
- [https://ai-2040.com/supplements/alignment-roadmap#research-areas](https://ai-2040.com/supplements/alignment-roadmap#research-areas)
- [Research Areas](https://ai-2040.com/supplements/alignment-roadmap#research-areas)
- [https://ai-2040.com/supplements/alignment-roadmap#phase-1-preparation](https://ai-2040.com/supplements/alignment-roadmap#phase-1-preparation)
- [Phase 1: Preparation](https://ai-2040.com/supplements/alignment-roadmap#phase-1-preparation)
- [https://ai-2040.com/supplements/alignment-roadmap#phase-2-mitigation-elicitation](https://ai-2040.com/supplements/alignment-roadmap#phase-2-mitigation-elicitation)
- [Phase 2: Mitigation + Elicitation](https://ai-2040.com/supplements/alignment-roadmap#phase-2-mitigation-elicitation)
- [https://ai-2040.com/supplements/alignment-roadmap#phase-3-pause](https://ai-2040.com/supplements/alignment-roadmap#phase-3-pause)
- [Phase 3: Pause](https://ai-2040.com/supplements/alignment-roadmap#phase-3-pause)
- [https://ai-2040.com/supplements/alignment-roadmap#phase-4-handoff](https://ai-2040.com/supplements/alignment-roadmap#phase-4-handoff)
- [Phase 4: Handoff](https://ai-2040.com/supplements/alignment-roadmap#phase-4-handoff)
- [https://ai-2040.com/supplements/alignment-roadmap#alignment-strategy-under-different-plans](https://ai-2040.com/supplements/alignment-roadmap#alignment-strategy-under-different-plans)
- [Alignment strategy under different plans](https://ai-2040.com/supplements/alignment-roadmap#alignment-strategy-under-different-plans)
- [https://ai-2040.com/supplements/alignment-roadmap#appendix-regimes-for-misalignment-schemeria-hackistan-etc](https://ai-2040.com/supplements/alignment-roadmap#appendix-regimes-for-misalignment-schemeria-hackistan-etc)
- [Appendix](https://ai-2040.com/supplements/alignment-roadmap#appendix-regimes-for-misalignment-schemeria-hackistan-etc)
- [https://ai-2040.com/supplements/alignment-roadmap#appendix-capability-threshold-definitions](https://ai-2040.com/supplements/alignment-roadmap#appendix-capability-threshold-definitions)
- [Appendix](https://ai-2040.com/supplements/alignment-roadmap#appendix-capability-threshold-definitions)
- [https://ai-2040.com/supplements/alignment-roadmap#appendix-other-definitions](https://ai-2040.com/supplements/alignment-roadmap#appendix-other-definitions)
- [Appendix](https://ai-2040.com/supplements/alignment-roadmap#appendix-other-definitions)
- [https://ai-2040.com/supplements/alignment-roadmap#appendix-how-this-plan-differs-from-other-alignment-plans](https://ai-2040.com/supplements/alignment-roadmap#appendix-how-this-plan-differs-from-other-alignment-plans)
- [Appendix](https://ai-2040.com/supplements/alignment-roadmap#appendix-how-this-plan-differs-from-other-alignment-plans)
- [insider’s perspective](https://www.ai-2040.com/?choices=plan-a-root#playbook-insider-pov)
- [https://ai-2040.com/supplements/alignment-roadmap#top-toc](https://ai-2040.com/supplements/alignment-roadmap#top-toc)
- [here](https://ai-2040.com/supplements/alignment-roadmap#id.cchz9nfob1p3)
- [philosophy](https://www.lesswrong.com/posts/EByDsY9S3EDhhfFzC/some-thoughts-on-metaphilosophy#Some_interrelated_ways_of_looking_at_philosophy)
...
- [Avoiding scheming (and getting a generally better understanding of scheming)](https://docs.google.com/document/d/1PCQKI3kAdE5HeEiIKN16gszu3kjF0bsowroZB7tDuS4/edit?tab=t.0)
- [Making AIs more useful for safety work](https://docs.google.com/document/d/12VkHm_QPnOzkkJOb88L8tTZ0VWeQnVA4HvwcuLyFy0w/edit?usp=sharing)
- [Deferring to AIs](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais)
- [Making deals with early schemers](https://www.lesswrong.com/posts/psqkwsKrKHCfkhrQx/making-deals-with-early-schemers)
- [model organisms](https://www.lesswrong.com/posts/ChDH335ckdvpxXaXX/model-organisms-of-misalignment-the-case-for-a-new-pillar-of-1)
- [natural schemers](https://www.lesswrong.com/posts/gALJWSfoTkq2ky5os/prospects-for-studying-actual-schemers)
- [AIs trained to behave similarly to schemers](https://www.lesswrong.com/posts/v6K3hnq5c9roa5MbS/reducing-risk-from-scheming-by-studying-trained-in-scheming#fnref-YqRrv2NFrtiLoYT6o-2)
- [abstract analogies to scheming models](https://www.lesswrong.com/posts/5zsLpcTMtesgF7c8p/two-proposed-projects-on-abstract-analogies-for-scheming)
- [here](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais#Behavioral_testing_for_capabilities_and__broad__alignment)
- [relatively easy to evaluate](https://www.lesswrong.com/posts/kcKrE9mzEHrdqtDpE/the-case-for-ensuring-that-powerful-ais-are-controlled#Evaluating_whether_you_have_control_is_doable)
- [here](https://www.lesswrong.com/posts/3s8PtYbo7rCbho4Ev/notes-on-control-evaluations-for-safety-cases)
- [here](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais)
- [this discussion of protocol evaluations](https://www.lesswrong.com/posts/qhaSoR6vGmKnqGYLE/protocol-evaluations-good-analogies-vs-control)
- [here](https://docs.google.com/document/d/1pJt4Rm4EnssE-_2Ha18Hy_dqiysFLhsegm2KUILls9Y/edit?tab=t.0#heading=h.jstxxz8vw8gf)
- [emergent misalignment](https://arxiv.org/abs/2502.17424?)
- [the reversal curse](https://arxiv.org/abs/2309.12288)
- [threat models](https://ai-2040.com/supplements/alignment-roadmap#id.udvsetxmzlaf)
- [start AI control](https://ai-2040.com/supplements/alignment-roadmap#id.nbxr9ch9lwee)
- [mitigations](https://ai-2040.com/supplements/alignment-roadmap#id.rugluk54vllx)
- [elicitation](https://ai-2040.com/supplements/alignment-roadmap#id.rflb0l8wzy6u)
- [slopolis](https://ai-2040.com/supplements/alignment-roadmap#id.mtfcktnazwio)
- [this paper claims](https://www.lesswrong.com/posts/L9sE9qQgeh7cTQWkM/can-aha-moments-be-fake-identifying-true-and-decorative)
- [here](https://www.alignmentforum.org/posts/GCqoks9eZDfpL8L3Q/how-to-prevent-collusion-when-using-untrusted-models-to)
- [Principle of least privilege](https://en.wikipedia.org/wiki/Principle_of_least_privilege)
- [The case for ensuring that powerful AIs are controlled](https://www.lesswrong.com/posts/kcKrE9mzEHrdqtDpE/the-case-for-ensuring-that-powerful-ais-are-controlled)
- [here](https://www.lesswrong.com/posts/YTZAmJKydD5hdRSeG/would-catching-your-ais-trying-to-escape-convince-ai)
- [here](https://docs.google.com/document/d/1nRJ-2FB_f4MPbKT7dAyWQyZdAh5djDt6dXsSqEMpKDA/edit?usp=sharing)
- [ways we can improve our safety mitigations](https://www.lesswrong.com/posts/i2nmBfCXnadeGmhzW/catching-ais-red-handed#Few_shot_catastrophe_prevention)
- [here](https://www.lesswrong.com/posts/XxjScx4niRLWTfuD5/handling-schemers-if-shutdown-is-not-an-option)
- [here](https://www.lesswrong.com/posts/i2nmBfCXnadeGmhzW/catching-ais-red-handed)
- [studying scheming using these examples](https://www.lesswrong.com/posts/gALJWSfoTkq2ky5os/prospects-for-studying-actual-schemers)
- [here](https://www.lesswrong.com/posts/gALJWSfoTkq2ky5os/prospects-for-studying-actual-schemers)
- [the post on improving AI usefulness](https://docs.google.com/document/d/12VkHm_QPnOzkkJOb88L8tTZ0VWeQnVA4HvwcuLyFy0w/edit?tab=t.0#heading=h.nsmuifumfqgt)
- [later in this doc](https://ai-2040.com/supplements/alignment-roadmap#building-good-behavioral-tests)
- [making deals with AI systems](https://www.lesswrong.com/posts/psqkwsKrKHCfkhrQx/making-deals-with-early-schemers)
- [here](https://www.rand.org/pubs/research_reports/RRA2849-1.html)
- [this post](https://www.lesswrong.com/posts/2wxufQWK8rXcDGbyL/access-to-powerful-ai-might-make-computer-security-radically)
- [Plan A scenario](https://ai-2040.com/)
- [the Basin of Good Deference](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais#Recursive_self_improvement_of_alignment_and_wisdom__the_hope_for_a_Basin_of_Good_Deference)
- [much more detail](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais)
- [An overview of approaches for avoiding scheming](https://docs.google.com/document/d/1PCQKI3kAdE5HeEiIKN16gszu3kjF0bsowroZB7tDuS4/edit?tab=t.0#heading=h.8n06a4t3bq9h)
- [Prospects for studying actual schemers](https://www.lesswrong.com/posts/gALJWSfoTkq2ky5os/prospects-for-studying-actual-schemers)
- [Iterated Development and Study of Schemers (IDSS)](https://www.lesswrong.com/posts/QpzTmFLXMJcdRkPLZ/iterated-development-and-study-of-schemers-idss)
- [Reducing risk from scheming by studying trained-in scheming behavior](https://www.lesswrong.com/posts/v6K3hnq5c9roa5MbS/reducing-risk-from-scheming-by-studying-trained-in-scheming)
- [this empirical work using an AI which expresses politically conservative views but only when it is confident that it is talking to a politically conservative user](https://www.lesswrong.com/posts/bhxgkb7YtRNwBxLMd/political-sycophancy-as-a-model-organism-of-scheming)
- [this post](https://www.lesswrong.com/posts/5zsLpcTMtesgF7c8p/two-proposed-projects-on-abstract-analogies-for-scheming)
- [Principled methods for avoiding scheming](https://docs.google.com/document/d/1pJt4Rm4EnssE-_2Ha18Hy_dqiysFLhsegm2KUILls9Y/edit?tab=t.0#heading=h.jstxxz8vw8gf)
- [using AIs for security](https://www.lesswrong.com/posts/2wxufQWK8rXcDGbyL/access-to-powerful-ai-might-make-computer-security-radically)
- [seems to remove many backdoors](https://arxiv.org/html/2510.18541v1?utm_source=chatgpt.com)
- [more](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais#Objectives_with_the_capability_profile)
- [more](https://www.lesswrong.com/posts/vjAM7F8vMZS7oRrrh/how-do-we-more-safely-defer-to-ais#Objectives_with_broad_alignment)
- [play to our outs](https://www.lesswrong.com/posts/xF7gBJYsy6qenmmCS/don-t-die-with-dignity-instead-play-to-your-outs)
- [Ten people on the inside](https://www.lesswrong.com/posts/WSNnKcKCYAffcnrt2/ten-people-on-the-inside)
- [Plan D](https://www.lesswrong.com/posts/E8n93nnEaFeXTbHn5/plans-a-b-c-and-d-for-misalignment-risk)
- [OpenAI Charter](https://openai.com/charter/)
- [these](https://arxiv.org/abs/2512.09742)
- [papers](https://arxiv.org/abs/2502.17424)
- [here](https://joecarlsmith.com/2025/08/18/giving-ais-safe-motivations#3-2-2-interpretability)
- [some amount of unreliable introspective access](https://transformer-circuits.pub/2025/introspection/index.html)
- [schemeria](https://ai-2040.com/supplements/alignment-roadmap#id.mtfcktnazwio)
...
- [a prior post](https://www.lesswrong.com/posts/WewsByywWNhX9rtwi/current-ais-seem-pretty-misaligned-to-me#Appendix__Heading_towards_Slopolis)
- [study scheming](https://www.lesswrong.com/posts/gALJWSfoTkq2ky5os/prospects-for-studying-actual-schemers)
- [improve our countermeasures with few-shot catastrophe prevention](https://www.lesswrong.com/posts/i2nmBfCXnadeGmhzW/catching-ais-red-handed#Few_shot_catastrophe_prevention)
- [MECE](https://en.wikipedia.org/wiki/MECE_principle)
- [alignment faking paper](https://www.anthropic.com/research/alignment-faking)
- [The Checklist](https://sleepinyourhat.github.io/checklist/)
- [Bumpers](https://alignment.anthropic.com/2025/bumpers/)
- [Planning for Extreme AI Risks](https://www.lesswrong.com/posts/8vgi3fBWPFDLBBcAx/planning-for-extreme-ai-risks)
- [Racing through a minefield](https://www.cold-takes.com/racing-through-a-minefield-the-ai-deployment-problem/)
- [Giving AIs safe motivations - Joe Carlsmith](https://joecarlsmith.com/2025/08/18/giving-ais-safe-motivations)
- [interpretability/transparency](https://joecarlsmith.com/2025/08/18/giving-ais-safe-motivations#3-1-behavioral-science)
- [current interpretability](http://lesswrong.com/posts/tEPHGZAb63dfq2v8n/how-useful-is-mechanistic-interpretability)
- [Redwood Research](https://blog.redwoodresearch.org/)
- [below](https://ai-2040.com/supplements/alignment-roadmap#id.nbxr9ch9lwee)
- [this](https://www.antischeming.ai/snippets)
- [Prefix cache untrusted monitors as a proposal for what to do after you catch your model](https://www.lesswrong.com/posts/Mxucm6BmJyCvxptPu/untitled-draft-pack)
- [OpenAI](https://www.forbes.com/sites/richardnieva/2026/02/03/sam-altman-explains-the-future/)
