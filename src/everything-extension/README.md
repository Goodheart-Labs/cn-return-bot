...
Community notes inline on the pages you read — Substack, YouTube, and any other site with notes (the extension installs with access to all sites), backed by the same Supabase database as [commonnotes.net](https://commonnotes.net).
