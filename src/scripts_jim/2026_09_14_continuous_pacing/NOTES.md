...
```
replaying 7 days · 79 feed posts, 3 reader posts · feed budget $45 · default mean $1
...
- The mean is over the last 48 hours, so an expensive post moves the pace only a little: on Sep 10 the paced row starts 5 posts spread over the day where the real day burst them out in the first three hours.
