...
# ///
"""Pull the four datasets the analysis needs into data/*.json.

1. pipeline_runs since June (feed_size picks reliable from then on): every
   processed post with its outcome, feed tier and misinfo flag.
...
Same shape as 2026_08_05_floor_optimization/pull_data.py, refreshed for this
investigation so both can be re-run independently.
"""
