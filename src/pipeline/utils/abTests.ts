...
const SIMPLE_BOT_SEARCH_TEST: ABTest = {
  ...
  variants: [
    { variant: { name: "sonnet46-native",         overrides: { search_model: "anthropic/claude-sonnet-4.6",       web_search: "native" }},        weight: 100 },
    ...
    { variant: { name: "gemini3pro-native",       overrides: { search_model: "google/gemini-3-pro",               web_search: "native_gemini" }}, weight: 0 },
    ...
    { variant: { name: "glm5-searxng",            overrides: { search_model: "zai/glm-5",                         web_search: "searxng" }},       weight: 0 },
    ...
    { variant: { name: "qwen3max-searxng",        overrides: { search_model: "alibaba/qwen-3-max",                web_search: "searxng" }},       weight: 0 },
