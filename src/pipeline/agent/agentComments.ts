...
export async function fetchTweetComments(
  ...
  const prompt = `Look at the replies and quote tweets to this tweet. Pick 5-10 representative comments (including the top comments). Give each reply's username, full text and engagement.
