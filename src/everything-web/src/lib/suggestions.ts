 ...
 *  Returns whether the edit was accepted (an accepted edit replaces the note
 *  in the UI via realtime). */
export async function submitImprovement(noteId: string, text: string): Promise<boolean> {
