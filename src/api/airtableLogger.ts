...
export class AirtableLogger {
  ...
  async logEntry(entry: AirtableLogEntry): Promise<void> {
    try {
      ...
      if (entry["Claim Opinion Score"] !== undefined) {
        fields["Claim Opinion Score"] = entry["Claim Opinion Score"];
      }
...
export function createLogEntry(
  ...
  if (claimOpinionScore !== undefined) {
    logEntry["Claim Opinion Score"] = claimOpinionScore;
  }
