...
Auth & interaction:
- **Reading** is anonymous. **Voting** and **writing/improving notes** require login (emailed 6-digit code or X) — votes key on `auth.uid()` via RLS; counters via trigger.
